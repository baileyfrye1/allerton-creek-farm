...
export default function Home() {
  return (
    <>
      <section
        className={`bg-[url('/images/cuttingboard-hero.JPG')] bg-cover relative bg-center h-dvh grid place-items-center md:h-96 after:content-[''] after:w-full after:h-full after:bg-black after:opacity-25 after:absolute`}
      >
